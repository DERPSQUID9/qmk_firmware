 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Home  |   1  |   2  |   3  |   4  |   5  |NextFX|           | ARRW |   6  |   7  |   8  |   9  |   0  |ALTCASE |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Home  |   1  |   2  |   3  |   4  |   5  |      |           |      |   6  |   7  |   8  |   9  |   0  |ALTCASE |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  End   |   Q  |   W  |   E  |   R  |   T  |      |           | MOUS |W Left|W Down| W Up |WRight|   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Page Up |   A  |   S  |   D  |   F  |   G  |------|           |------| Left | Down |  Up  |Right |   ;  |   -    |
 * |--------+------+------+------+------+------|      |           |Delete|------+------+------+------+------+--------|
 * |PageDown|   Z  |   X  |   C  |   V  |   B  |      |           |      |M Left|M Down| M Up |MRight|   /  |   =    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | ESC  |  `~  |  '"  | Left |Right |                                       |  Up  | Down |   [  |   ]  |        |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 ...
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Home  |   1* |   2* |   3* |   4* |   5* | F2*  |           |Alt-T*|   6* |   7* |   8* |   9* |   0* |ALTCASE |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  End   |   Q* |   W* |   E* |   R  |   T* |      |           |Enter*|   Y  |   U* |   I  |   O* |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Page Up |   A  |   S* |   D  |   F* |   G  |------|           |------|   H  |   J  |   K  |   L* |   ;  |   -    |
 * |--------+------+------+------+------+------| KTTY |           |Delete|------+------+------+------+------+--------|
 * |PageDown|   Z  |   X  |   C* |   V* |   B* |      |           |      |   N* |   M  |   ,* |   .* |   /  |   =    |
