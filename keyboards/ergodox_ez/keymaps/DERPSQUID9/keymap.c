 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | MDIA   |   1  |   2  |   3  |   4  |   5  |      |           | ARRW |   6  |   7  |   8  |   9  |   0  | C+A+D  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 */
  [BASE] = LAYOUT_ergodox_pretty(
    MO(MDIA),        KC_1,     KC_2,     KC_3,    KC_4,     KC_5, XXXXXXX,                                                         TG(ARRW),  KC_6, KC_7,  KC_8,     KC_9,        KC_0,        RALT(RCTL(KC_DELETE)),
    XXXXXXX,         KC_Q,     KC_W,     KC_E,    KC_R,     KC_T, TT(FNCT),                                                        TG(MOUS),  KC_Y, KC_U,  KC_I,     KC_O,        KC_P,        KC_BSLASH,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |Mac1Rec |  F1  |  F2  |  F3  |  F4  |  F5  |      |           | ARRW |  F6  |  F7  |  F8  |  F9  |  F10 | C+A+D  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 */
  [FNCT] = LAYOUT_ergodox_pretty(
    DYN_REC_START1, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                   _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | MDIA   |   1  |   2  |   3  |   4  |   5  |      |           | ARRW |   6  |   7  |   8  |   9  |   0  | Reset  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |   Q  |   W  |   E  |   R  |   T  | FNCT |           | MOUS |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Mac1Play|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |   -    |
 ...
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | MDIA   |   1* |   2* |   3* |   4* |   5* | F2*  |           |Alt-T*|   6* |   7* |   8* |   9* |   0* | C+A+D  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
